...
def evaluate_model(model_or_path, test_images, test_labels, num_classes=None, conf_threshold=0.001):
    ...
    if not all_preds or not all_gts:
        return {**_empty_results(num_classes), 'num_predictions': num_preds, 'num_ground_truth': num_gts}
