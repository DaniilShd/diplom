...
from generate.scripts.config import Config
from generate.scripts.generate_dataset import PoissonDefectGenerator

logger = logging.getLogger(__name__)


def generate_synthetic_dataset(run_params, fixed_params, synthetic_output_dir, real_train_dir, rle_csv):
    config = Config()
    ...
    logger.info(f"Generating: variants={run_params['variants']}, "
                f"defect_strength={run_params['sd_defect_strength']}, "
